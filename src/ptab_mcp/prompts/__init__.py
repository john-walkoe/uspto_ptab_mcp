...
def register_prompts(mcp_server):
    ...
    from . import trial_precedent_research
    from . import complete_trial_litigation_package
    from . import prior_art_board_decision_mining
    from . import trial_timeline_analysis
    from . import ipr_challenge_defense_PFW
    from . import ipr_petitioner_portfolio_analysis_PFW
    from . import portfolio_ptab_risk_assessment_PFW_FPD
    from . import technology_landscape_ptab_analysis_PFW
    from . import cross_mcp_patent_intelligence_PFW
    from . import ptab_prior_art_validation_PFW_CITATIONS
    from . import complete_prosecution_lifecycle_PFW_FPD_CITATIONS
