...
- **Method**: Hybrid extraction (PyPDF2 → Mistral OCR if needed)
- **Cost**: ~$0.15 per 1M input tokens (Mistral OCR)
...
**ptab_validate_identifiers** - Validation
- **Purpose**: Validate trial/appeal/interference number formats
- **Use Cases**: Pre-flight validation, format checking
...
# Use validation tool:
result = ptab_validate_identifiers(
    trial_number='IPR2024-00123'
)
```
